...
public class Disc_Movement : MonoBehaviour
{
 ...
 private double cd = 0;
    ...
    // Orientation:
        ...
        // double check deltatime problem!
        // Find rotations alpha, pitch
     */
    ...
    void Update()
    {
        ...
        // calculate relative forward angle
      ...
      //  Debug.Log(transform.localToWorldMatrix.m11*100/5);
        ...
        // realtime alpha angle
          ...
          Debug.Log(transform.forward.magnitude);
            ...
            Debug.Log(Vector3.Cross(transform.forward, rigidBody.velocity).sqrMagnitude);
 */
